...
// daliname teksa i zodzius atskirtus tarpais nuo pradzios

//reikia is teksto atskirti pirma zodi (komanda), paskutini zodi (failo varda), preispaskutini zodi (operatorius)
...
VMINT parseText2(VMSTR text) {
    ...
    while (*ptr != '\0') {
           ...
           if (*ptr == ' ') {
              ...
              if (counter == 1) {strcpy(text222, nauj_strng);}
              if (counter == 2) {strcpy(text333, nauj_strng);}
              if (counter == 3) {strcpy(text444, nauj_strng);}
    ...
    if (counter == 0) {strcpy(text222, nauj_strng);}
    if (counter == 1) {strcpy(text333, nauj_strng);}
    if (counter == 2) {strcpy(text444, nauj_strng);}
    if (counter > 2) {strcpy(text555, nauj_strng);}
