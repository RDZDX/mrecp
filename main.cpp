...
VMCHAR text4[150] = "about        - show program information\nhelp         - list available commands\necho         - print string\ndir          - list of files and subs\n";
VMCHAR text5[113] = "cd           - changes the current dir\ncls          - clear screen\nexit         - quits the program\n\n";
	...
	if (port == -3) {
		...
		//console_str_in("\nPlease enter the port: ");
                ...
                else if (vm_string_equals_ignore_case(text11, "dir") == 0)
                {
                  ...
                  vm_ucs2_to_ascii(text, wstrlen(fileInfo.filefullname) + 1, fileInfo.filefullname);
                  strcat(text, "\n");
                  console_str_in(text);

	          while(kounteris < 50 || test > 0){ 
